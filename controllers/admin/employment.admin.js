...
function getEmployment(req, res) {
    ...
    emMSSQL.once('results', function (dataMSSQL) {
            ...
            emMYSQL.once('results', function (dataMYSQL) {
                ...
                for (var i = 0; i < dataMSSQL.length; i++) {
                    var dataRaw = {
                        Employee_ID: dataMYSQL[i]['idEmployee'],
    ...
    function updateEmployment(req, res) {
        ...
        console.log(dataMssql);
        console.log(dataMySql);
        var emMYSQL = new employMYSQL.updateEmployee(dataMySql, req.body.idEmployee);
        var emMSSQL = new employMSSQL.updateEmployment(dataMssql, req.body.idEmployee);
        res.redirect('/admin/employment');
    }
